...
/** The fee in Sats to use for Creating or Redeeming B1T Promos */
...
/**
 * Sets the mode of the B1T Promos UI
...
/**
 * Create a new 'B1T Promos' code with a webworker
...
/** Export and download all B1T Promos data in to a CSV format */
export async function promosToCSV() {
    const arrCSV = [
        // Titles
        ['Promo Code', 'B1T (Remaining)', 'Funding Address'],
        // Content
    ];
...
/**
 * @type {Worker?} - The thread used for the B1T Promos redeem process
 */
export let promoThread = null;

/**
 * Derive a 'B1T Promos' code with a webworker
...
/**
 * Prompt a QR scan for a B1T Promos code
 */
