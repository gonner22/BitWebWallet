 ...
 * @property {string} name - B1T address string
 ...
 * @property {number} decimals - Decimal places in the amounts (B1T has 8 decimals)
...
export class ExplorerNetwork extends Network {
    ...
    // B1T Labs Analytics: if you are a user, you can disable this FULLY via the Settings.
