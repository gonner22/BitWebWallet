...
export async function delegateGUI() {
    ...
    // Verify the amount; Delegations must be a minimum of 1 B1T, enforced by the network
 ...
 * @param {boolean} options.delegateChange - If there is at least 1.01 B1T of change, the change will be delegated to options.changeDelegationAddress
